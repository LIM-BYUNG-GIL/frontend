...
console.log('7-2) 월 : ' + today.getMonth())    // 월을 number로 표기할때는 0~11
...
// 여러분의 탄생일 기준 + 3000일은?
let mybirth = new Date('1993-06-14')
...
// 나는 태어난지 며칠 ?
mybirth = new Date('1993-06-14')
let diff = new Date() - mybirth
console.log('5) new Date() - mybirth')
console.log(diff)
console.log(diff + "ms")        // ms를 일로 바꾸기 1일 = 24시간*60분*60*1000ms
